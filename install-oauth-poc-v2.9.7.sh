#!/usr/bin/env bash
# Promote to King v2.9.7 OAuth POC protected-configuration installer.
set -u
...
DEFAULT_REDIRECT="${P2K_BASE_URL:-https://www.promotetoking.org}/OAuthTest.php"
...
chmod 600 "$TARGET" 2>/dev/null || true
echo "Installed protected OAuth POC configuration: $TARGET"
echo "Future Promote to King release payloads do not contain oauth.local.php."
echo "Test URL: ${P2K_BASE_URL:-https://www.promotetoking.org}/OAuthTest.php?oauth=2"
