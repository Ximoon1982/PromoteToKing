...
if [[ $# -ne 0 ]]; then
  echo "This v2.8.9 helper takes no arguments." >&2
  exit 2
fi
...
echo "Installed Promote to King v2.8.9 crontab for user: $(id -un)"
