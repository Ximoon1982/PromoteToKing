...
if [[ $# -ne 0 ]]; then
  echo "This v2.8.8 helper takes no arguments." >&2
  exit 2
fi
...
echo "Installed Promote to King v2.8.8 crontab for user: $(id -un)"
