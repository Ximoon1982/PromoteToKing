...
function membersTableColumns() {
  ...
  async function openOpponentProfile(slug) {
    ...
    try {
      ...
      <section class="p2k-opponent-breakdown-grid"><article class="p2k-profile-section"><h3>Win rate by time control</h3><div id="opponentTimeControlRates" class="p2k-native-chart"></div></article><article class="p2k-profile-section"><h3>Win rate by match rating cap</h3><div id="opponentRatingRates" class="p2k-native-chart"></div></article></section>
