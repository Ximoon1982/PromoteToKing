...
(() => {
  ...
  function recruitHref() {
    const url = new URL("ui-v2.html", document.baseURI);
    url.searchParams.set("ui", "v2");
    url.searchParams.set("view", "admin");
    url.searchParams.set("adminCategory", "competitions");
    url.searchParams.set("adminDetail", "matchRecruitment");
    url.searchParams.set("adminDetailTab", "recruitment");
  ...
  function install() {
    ...
    card.dataset.adminDetail = "matchRecruitment";
    card.dataset.adminDetailTab = "recruitment";
    card.dataset.adminDetailCategory = "competitions";
    ...
    card.innerHTML = `
      ...
      <footer class="dashboard-admin-shell-actions"><a class="dashboard-button" data-admin-shell-route="1" data-v2121-match-recruitment-open>Open Match Recruitment</a></footer>`;
    card.querySelector("[data-v2121-match-recruitment-open]").href = recruitHref();
