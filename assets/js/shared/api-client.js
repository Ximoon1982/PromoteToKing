...
(() => {
  ...
  function userMessage(error) {
    ...
    const messages = {
      ...
      timeout: "The Chess.com API did not respond in time.",
      network: "The Chess.com API could not be reached.",
      "not-found": "The requested Chess.com resource was not found.",
      ...
      server: "Chess.com returned a temporary server error.",
      client: "The request could not be completed.",
      parse: "Chess.com returned data that could not be read.",
      cache: "The local cache could not provide this response."
    };
