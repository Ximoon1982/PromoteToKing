...
bash "$ROOT/tools/release/v2134/build-universal-2.13x.sh" "$OUT" >/dev/null
INSTALLER="$OUT/$PKG/install-promote-to-king-v2.13.4.sh"
...
echo "v2.13.4 universal 2.13.x installer baseline gate passed"
