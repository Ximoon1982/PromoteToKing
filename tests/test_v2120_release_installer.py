...
def test_installer_contract():
 ...
 for x in ("set -Eeuo pipefail","SUPPORTED_BASELINES.sha256","verify_package","verify_installed","rollback","cron.before","P2K_FORCE_INSTALL_FAILURE_AFTER"):assert x in i
